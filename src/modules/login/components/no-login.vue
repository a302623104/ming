  ...
  <div class="nologin">
    ...
    <div class="main">
      <div class="inputgroup">
        ...
        <button class="checkpwd" @click="changemode()" :style="{backgroundImage:btnimg}"></button>
