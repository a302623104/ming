  ...
  <div class="register">
    ...
    <div class="main">
      <div class="inputgroup">
        <span class="importent">*</span>用户名<input type="text" id="username" placeholder="用户名/手机" v-model="username">
        <span class="importent">*</span>密码<input type="password" id="password" placeholder="密码" maxlength="16" v-model="password">
  ...
  export default {
    ...
    methods:{
      regis(){
        ...
        if(userresult === true && passresult === true && this.imgcheck === true){
